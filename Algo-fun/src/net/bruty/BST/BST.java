...
public class BST {
    ...
    public static int findClosestValue(@NotNull BST tree, int target){
        return findClosestValue(tree, target, 0);
    }
    public static int findClosestValue(@NotNull BST tree, int target, int closest){
